-- FabriSync single-source calculation compatibility.
-- New Flutter orders persist department hours from OrderCalculationService in
-- ordersmain.estimated_dept_hours. Workflow triggers must prefer those stored
-- values and use master_time_config only as a legacy fallback.
